...
namespace Nyous.Controllers
{
    ...
    {
        //chamando o contexto do banco
        NyousContext _ctx = new NyousContext();

        //Capturar informações do token do appsetting.json
        ...
        //Pega info de acesso por escrito, ex: Padrao ou Adm
